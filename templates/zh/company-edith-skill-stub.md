---
name: <company-edith>
description: 面向 <company/product> EDITH instance 的统一入口 skill。当 agent 需要查询公司知识、路由到正确的 module 或 source、遵循 cross-cutting guidance，或维护 EDITH instance 本身时使用。
---
...
### END
- 把可持续复用的知识写回正确的 EDITH 文件
- 遵循 maintenance guide，不要临时发明 回写 规则

## 维护

当维护 EDITH instance 本身时，以根目录的 `MAINTENANCE.md` 作为 权威来源。
